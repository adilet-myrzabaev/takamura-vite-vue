                ...
                >
                    <template #header>
                        <div class="flex md:justify-content-between md:align-items-center">
                            ...
                            <Button class='bg-transparent text-gray-800 border-black-alpha-80' label="Secondary" severity="secondary" text raised  @click='openNew()' style='border: 1px solid #ced4da !important;'>
                                <span class='text-md'>Новый продукт</span>
                            </Button>
